...
function Header() {
  ...
  switch (season) {
    case 'winter':
      sloganPeriode =
        'Un bon café et une romance de noël pour se réchauffer en hiver !'
      break
    case 'spring':
      sloganPeriode =
        "Le printemps, c'est la saison idéale pour un café et un roman feel-good en terrasse !"
      break
    case 'summer':
